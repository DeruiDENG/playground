...
import { G964 } from './countKeyPrimes';
...
describe('Fixed Tests', function() {
  it('Basic tests countKprimes', function() {
    ...
    expect(G964.countKprimes(3, 0, 100)).toEqual([
      8,
      12,
      18,
      20,
    ...
    expect(G964.countKprimes(5, 1000, 1100)).toEqual([
      1020,
      1026,
      1032,
      1044,
    ...
    expect(G964.countKprimes(5, 500, 600)).toEqual([
      500,
      520,
      552,
      567,

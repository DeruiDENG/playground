...
import { decrypt, encrypt } from '../../../src/codewar/level5/simpleEncryption';
...
describe("solution", function(){
  it("EncryptExampleTests", function(){
    ...
    assert.equal(encrypt("Do the kata Kobayashi Maru Test. Endless fun and excitement when finding a solution.", 583), "Sr pgi jlpl Jr,lqlage Zlow Piapc I.skiaa dw. l.s ibnepizi.p ugi. de.se.f l arkwper.c");
  });
  ...
  it("DecryptExampleTests", function(){
    ...
    assert.equal(decrypt("Sr pgi jlpl Jr,lqlage Zlow Piapc I.skiaa dw. l.s ibnepizi.p ugi. de.se.f l arkwper.c", 583), "Do the kata Kobayashi Maru Test. Endless fun and excitement when finding a solution.");
  });
});
